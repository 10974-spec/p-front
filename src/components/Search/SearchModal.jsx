            ...
            <div className="space-y-2">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-4 py-4 rounded-xl border border-primary-300 focus:border-green-500 focus:ring-2 focus:ring-green-200 outline-none transition-all text-lg"
                ...
                <button
                  ...
                  className={`w-full p-4 rounded-xl border-2 text-left transition-all ${
                    searchParams.category === category.value
                      ...
                      : 'border-primary-300 hover:border-green-300 hover:bg-primary-50'
                  }`}
                >
        ...
        return (
          <div className="space-y-6">
            ...
            <div className="bg-green-50 rounded-xl p-4 border border-green-200">
              <h4 className="font-semibold text-green-800 mb-2">Your Search Criteria:</h4>
